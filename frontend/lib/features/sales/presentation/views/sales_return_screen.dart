...
class _SalesReturnScreenState extends ConsumerState<SalesReturnScreen> {
  ...
  final List<String> _columnLabels = [
    '', 'RETURN NO', 'INVOICE NO', 'DATE', 'TOTAL AMOUNT', 'REASON'
  ];
    ...
    return MainLayout(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const BreadcrumbWidget(items: ['Home', 'Sales Return']),
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        const Text('All Sales Return', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Color(0xFF1e293b))),
                        ...
                        const Spacer(),
                        PosButton(label: '+ Add Sale Return', onTap: () => context.go('/sales-return/create')),
                    ...
                    data: (returns) {
                      ...
                      return PosTable(
                        ...
                        rows: filtered.map((r) => [
                          ...
                          Text(r.saleId ?? '-', style: const TextStyle(fontSize: 13, color: Color(0xFF334155))),
